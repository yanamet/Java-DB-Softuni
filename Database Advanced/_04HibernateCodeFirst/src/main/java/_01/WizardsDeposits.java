...
public class WizardsDeposits {
    ...
    public WizardsDeposits(String firstName, String lastName, String notes, int age, String magicWandCreator,
                           short magicWandSize, String depositGroup, LocalDateTime depositStartDate,
                           float depositAmount, float depositInterest,
                           float depositCharge, LocalDateTime depositExpirationDate, boolean depositExpired) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.notes = notes;
        this.age = age;
